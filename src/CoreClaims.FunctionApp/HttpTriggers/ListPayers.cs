...
namespace CoreClaims.FunctionApp.HttpTriggers
{
    public class ListPayers
    {
        ...
        public async Task<HttpResponseData> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "payers")] HttpRequestData req,
            FunctionContext context)
        {
            ...
            using (logger.BeginScope("HttpTrigger: ListPayers"))
            {
                ...
                var result = await _repository.ListPayers(offset, limit, sortColumn, sortDirection);
